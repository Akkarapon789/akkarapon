...
-- Database: `msu`
--
CREATE DATABASE IF NOT EXISTS `msu_akkarapon` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `msu_akkarapon`;
...
('66010915570', 'นายสมปอง น้องสมหมาย', 'อุดรธานี', 3.45, 2),
('66010915575', 'นายขนม อะไร', 'มหาสารคาม', 3.59, 1),
('66010915584', 'นางสาวไปนา มานะ', 'มหาสารคาม', 3.44, 2),
('66010915594', 'นางสาวฟ้าใส ใจดี', 'ขอนแก่น', 3.55, 4),
('66010915602', 'นางสาวธิดา ไปมา', 'เชียงใหม่', 3.00, 7),
('66010915689', 'นายไปไส มา', 'ขอนแก่น', 3.58, 3),
...
--
ALTER TABLE `faculty`
  MODIFY `f_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2147483648;
COMMIT;
