...
<body>
	<h1>เพิ่มข้อมูลนิสิต -- ขจรศักดิ์ จันทรเสนา(ฮาร์ท)</h1>
	...
	?>
        	<option value="<?php echo $data2['f_id'];?>"<?php if($data2['f_id']==$data3['f_id']){ echo "selected";}else{echo"";}?> ><?php echo $data2['f_name'];?>
            </option>
            <?php } ?>
        </select>
        <br><br>
